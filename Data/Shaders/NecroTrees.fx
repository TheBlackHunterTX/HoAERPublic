...
{
   VS_OUTPUT Out;
   Pos.xyz-=N*(15+cos(Time*3-Pos.z/2)*2)*(stage.y-0.75)*4;
   Pos.z*=2/(stage.y+1);//DeathStage;
   ...
   Out.Blend.w=stage.x*stage.y*stage.y*abs(Out.Blend.w)*2;
   return Out;
}
...
technique RenderScene
{
	pass P0
	{
		...
		ColorArg1[1]		= Current;
		ColorArg2[1]		= Texture;
		AlphaOp[1]			= Modulate2x;//AddSigned2x;//BlendDiffuseAlpha;
		AlphaArg1[1]		= Diffuse;
		AlphaArg2[1]		= Texture;
		AddressU[1]			= Wrap;
		AddressV[1]			= Wrap;
